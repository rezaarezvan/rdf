...
def plot_convex_functions(ax=None, color_map=None):
    ...
    min_x1, min_y1 = 0, 0
    ax1.plot(min_x1, min_y1, 'o', color=color_map['c1'],
    ...
    ax2.plot(min_x2, min_y2, 'o', color=color_map['c2'],
             markersize=8, label='Local Minima')

    # Add saddle point
    saddle_x, saddle_y = 0, 1
    ax2.plot(saddle_x, saddle_y, 's', color=color_map['c3'],
             markersize=8, label='Saddle Point')
